...
import { Provider as MulticallProvider, Contract as MulticallContract } from '@alexastrabit/ethcall';
...
import gaugeFactoryABI from './constants/abis/gauge_factory_mainnet.json';
import gaugeFactorySidechainABI from './constants/abis/gauge_factory_sidechain.json';
